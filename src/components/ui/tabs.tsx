...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-14 items-center justify-center rounded-2xl glass-surface p-1 text-muted-foreground shadow-soft",
      className,
    )}
    {...props}
  />
